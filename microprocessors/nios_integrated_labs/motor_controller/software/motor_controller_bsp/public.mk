...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2010
SOPC_SYSID_FLAG += --sidp=0x2010
ELF_PATCH_FLAG  += --sidp 0x2010

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1587533446
SOPC_SYSID_FLAG += --timestamp=1587533446
ELF_PATCH_FLAG  += --timestamp 1587533446
