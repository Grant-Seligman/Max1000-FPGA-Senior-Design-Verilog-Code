...
module nios_sys_mm_interconnect_0 (
	...
	wire  [13:0] pio_data_s1_agent_m0_address;                                                // pio_data_s1_agent:m0_address -> pio_data_s1_translator:uav_address
	...
	wire  [90:0] pio_data_s1_agent_rf_source_data;                                            // pio_data_s1_agent:rf_source_data -> pio_data_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] pio_data_s1_agent_rsp_fifo_out_data;                                         // pio_data_s1_agent_rsp_fifo:out_data -> pio_data_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> pio_data_s1_agent:cp_valid
	wire  [89:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> pio_data_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // pio_data_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> pio_data_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> pio_data_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> pio_data_s1_agent:cp_endofpacket
	...
	wire         pio_data_s1_agent_rp_valid;                                                  // pio_data_s1_agent:rp_valid -> router_006:sink_valid
	wire  [89:0] pio_data_s1_agent_rp_data;                                                   // pio_data_s1_agent:rp_data -> router_006:sink_data
	wire         pio_data_s1_agent_rp_ready;                                                  // router_006:sink_ready -> pio_data_s1_agent:rp_ready
	wire         pio_data_s1_agent_rp_startofpacket;                                          // pio_data_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_data_s1_agent_rp_endofpacket;                                            // pio_data_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pio_data_s1_agent_rdata_fifo_src_valid;                                      // pio_data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_data_s1_agent_rdata_fifo_src_data;                                       // pio_data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_data_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> pio_data_s1_agent:rdata_fifo_src_ready
